...
const Bag: React.FC = () => {
	...
	const bagDataCountRed = useSelector((state: RootState) => state.bag.bagData_count) ?? []
	...
	useEffect(() => {
		if (bagDataCountRed < 1) navigate(ROUTE_CONSTANTS.HOME)
	}, [])

	return (
		<>
			<div className='mx-auto'>
				<h2 className="text-4xl underline mb-4 text-left">Bags Details</h2>
